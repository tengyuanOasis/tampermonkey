...
class PromptBox {
	constructor() {
		this.mode = [
			...
			{
				name: '英译中',
				value: '下面我让你来充当翻译家，你的目标是把任何语言翻译成中文，请翻译时不要带翻译腔，而是要翻译得自然、流畅和地道，使用优美和高雅的表达方式。'
			},
			{
				name: '中译英',
				value: '下面我让你来充当翻译家，你的目标是把中文翻译成英文，请翻译时不要带翻译腔，而是要翻译得自然、流畅和地道，使用优美和高雅的表达方式。'
			},
			{
				name: 'codeif',
...
const mode = [
	...
	},
	{
		...
		value:
			'我想让你充当 stackoverflow 的帖子。我会问与编程相关的问题，你会回答应该是什么答案。我希望你只回答给定的答案，并在不够详细的时候写解释。不要写解释。当我需要用英语告诉你一些事情时，我会把文字放在大括号内{like this}。'
>>>>>>> a4d2086d027e64cfdc9e1eb2e33681a96d3b89c8
	}
	...
	attachEventHandlers() {
		...
		this.box.addEventListener('click', (e) => {
			if (e.target.tagName === 'LI') {
				...
				const value = this.mode[index].value;
				this.sendMsg(value);
			}
		});
